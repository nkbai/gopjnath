...
/*
#cgo CFLAGS: -I ${SRCDIR}/pjnath   -g -O2  -DPJ_AUTOCONF=1 -O2 -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
#cgo darwin,amd64 LDFLAGS:  -L ${SRCDIR}/pjnath/lib-darwin-amd64 -lpjlib-util-x86_64-apple-darwin17.5.0  -lpjnath-x86_64-apple-darwin17.5.0 -lpjlib-util-x86_64-apple-darwin17.5.0  -lpj-x86_64-apple-darwin17.5.0 -lm -lpthread 
#cgo android,arm LDFLAGS:  -L ${SRCDIR}/pjnath/lib-darwin-amd64 -lpjlib-util-x86_64-apple-darwin17.5.0  -lpjnath-x86_64-apple-darwin17.5.0 -lpjlib-util-x86_64-apple-darwin17.5.0  -lpj-x86_64-apple-darwin17.5.0 -lm -lpthread 
#include <pjlib.h>
